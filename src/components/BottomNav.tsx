...
export default function BottomNav({
  ...
  const [loadedTabs, setLoadedTabs] = useState(() => new Set([active]));
  ...
  React.useEffect(() => {
    setLoadedTabs((previous) => previous.has(active) ? previous : new Set(previous).add(active));
  }, [active]);
