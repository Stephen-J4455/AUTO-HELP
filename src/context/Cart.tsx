  ...
  async function loadCart(userId: string) {
    ...
    const mapped = ((data as Array<Record<string, unknown>>) || []).map((row) => {
      const product = row.products as
        | { title?: unknown; price?: unknown; images?: unknown; weight_kg?: unknown; pay_on_delivery?: unknown }
        | Array<{ title?: unknown; price?: unknown; images?: unknown; weight_kg?: unknown; pay_on_delivery?: unknown }>
        | null;
