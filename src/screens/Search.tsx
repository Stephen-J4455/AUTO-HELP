        ...
        <View style={styles.skeletonList}>
          {[0, 1, 2, 3, 4].map((item) => (
            <View key={item} style={[styles.skeletonCard, { backgroundColor: colors.surface }]}>
              <View style={[styles.skeletonImage, { backgroundColor: colors.background }]} />
              <View style={styles.skeletonBody}>
                <View style={[styles.skeletonLine, styles.skeletonTitleLine, { backgroundColor: colors.background }]} />
                <View style={[styles.skeletonLine, styles.skeletonLongLine, { backgroundColor: colors.background }]} />
                <View style={[styles.skeletonLine, styles.skeletonShortLine, { backgroundColor: colors.background }]} />
              </View>
            </View>
          ))}
        </View>
...
const styles = StyleSheet.create({
  ...
  skeletonCard: { height: 96, borderRadius: 18, flexDirection: 'row', overflow: 'hidden' },
  skeletonImage: { width: 96, height: 96 },
  skeletonBody: { flex: 1, padding: 14, gap: 9 },
  skeletonLine: { height: 11, borderRadius: 6 },
  skeletonTitleLine: { width: '72%' },
  skeletonLongLine: { width: '92%' },
  skeletonShortLine: { width: '42%' },
